...
var PurchaseInvoiceCounter = mongoose.model('PurchaseInvoiceCounter', CounterSchema);
...
PurchaseInvoiceSchema.pre("save", function (next) {
  ...
  PurchaseInvoiceCounter.findByIdAndUpdate({_id: "61f7f1819d18dd4559a00a7d"}, {$inc: { seq: 1} }, function(error, PurchaseInvoiceCounter)   {
      if(error)
      {
          console.log(PurchaseInvoiceCounter);
          return next(error);
      }
      console.log(PurchaseInvoiceCounter.seq + "ffffffffffffffffffffffff");
      ...
      if(PurchaseInvoiceCounter.year == last2Num)
      {
        console.log(last2Num + " same year");
      } else {
        PurchaseInvoiceCounter.year = last2Num;
        PurchaseInvoiceCounter.seq = 1;

        PurchaseInvoiceCounter.save(function (err) {
      ...
      var sequenc = PurchaseInvoiceCounter.seq;
...
module.exports = {
  ...
  PurchaseInvoiceCounter: PurchaseInvoiceCounter
};
