...
const verify = require("../middleware/verifyDeveloper");
...
const contentRootPath = "/home/ubt/FileManager";
...
router.get("/filemanager", verify, async (req, res) => {
...
router.get("/bugs", verify, async (req, res) => {
    // console.log(req.body);
    // req.keep = "true";
 ...
 */
router.get('/filemanager/GetImage', verify, function (req, res) {
    replaceRequestParams(req, res);
 ...
 */
router.post('/filemanager/Upload', verify, multer(multerConfig).any('uploadFiles'), function (req, res) {
    replaceRequestParams(req, res);
 ...
 */
router.post('/filemanager/Download', verify, function (req, res) {
    replaceRequestParams(req, res);
 ...
 */
router.post('/filemanager', verify, function (req, res) {
    console.log("start filemanger");
    ...
    function getRules() {
        ...
        console.log(accessRuleFile);
        if (!fs.existsSync(accessRuleFile)) { return null; } else { console.log("permission file founded");}
    ...
    // console.log("filename, contentRootPath, fileList, files, index" + filename, contentRootPath, fileList, files, index);
    // console.log("filename, contentRootPath, fileList, files, index" + contentRootPath + fileList +  files + index);
