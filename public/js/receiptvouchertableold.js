$(document).ready(function () {
    ...
    let ajax = new ej.base.Ajax(
      hostUrl + "/ReceiptSearch/GetData?action=all&id=2",
      "post"
    );
    ...
    ajax.onSuccess = function (result) {
      var data = new ej.data.DataManager({
        ...
        insertUrl: hostUrl + "/ReceiptSearch/GetData?action=voucher&id=2",
        updateUrl: hostUrl + "/ReceiptSearch/GetData?action=voucher&id=2",
        removeUrl: hostUrl + "/ReceiptSearch/GetData?action=voucher&id=2",
        //,
        // adaptor: new ej.data.RemoteSaveAdaptor(), //remote save adaptor
