$( document ).ready(function() {
    ...
    let ajax = new ej.base.Ajax(hostUrl + "GetDataProject", "post");
    ajax.send();
    ajax.onSuccess = function (result) {
        ...
        var data = new ej.data.DataManager({
            ...
            insertUrl: hostUrl + "Project", 
            updateUrl: hostUrl + "Project", 
            removeUrl: hostUrl + "Project"
        });
