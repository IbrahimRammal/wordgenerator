$( document ).ready(function() {
    ...
    let ajax = new ej.base.Ajax(hostUrl + "GetDataPronto", "post");
    ajax.send();
    ajax.onSuccess = function (result) {
        ...
        var data = new ej.data.DataManager({
            ...
            insertUrl: hostUrl + "Pronto", 
            updateUrl: hostUrl + "Pronto", 
            removeUrl: hostUrl + "Pronto"
        });
        ...
        var grid = new ej.grids.Grid({
            ...
            columns: [
                {
                    field: 'pronto', headerText: 'project',
