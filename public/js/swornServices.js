$( document ).ready(function() {
    ...
    let ajax = new ej.base.Ajax(hostUrl + "GetDataSworn", "post");
    ajax.send();
    ajax.onSuccess = function (result) {
        ...
        var data = new ej.data.DataManager({
            ...
            insertUrl: hostUrl + "Sworn", 
            updateUrl: hostUrl + "Sworn", 
            removeUrl: hostUrl + "Sworn"
        });
        ...
        var grid = new ej.grids.Grid({
            ...
            columns: [
                {
                    field: 'sworn', headerText: 'project',
