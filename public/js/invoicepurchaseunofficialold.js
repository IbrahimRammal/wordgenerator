$(document).ready(function () {
    ...
    $.ajax({
        url: "/api/invoice/invoiceedit/GetData?action=purchaseunofficial&id=2",
        type: "POST",
        dataType: "json",
        cache: true,
        //data: { },
    ...
    var data = new ej.data.DataManager({
        ...
        insertUrl: hostUrl + "invoiceedit/GetData?action=purchaseunofficial&id=2",
        updateUrl: hostUrl + "invoiceedit/GetData?action=purchaseunofficial&id=2",
        removeUrl: hostUrl + "invoiceedit/GetData?action=purchaseunofficial&id=2",
    });
      ...
      cellSelected: (args) => {
        ...
        if (cellContent.includes('fa-download')) {
          ...
          $.ajax({
            ...
            dataType: "json",
            cache: true,
            data: { language: "English", docModel: "UnofficialPurchaseInvoice", clientname: args.data.fullname, docID: args.data.docid },
          ...
          $.ajax({
            ...
            data: { language: "English", docModel: "UnofficialPurchaseInvoice",currency: args.data.currency, total: args.data.total, docID: args.data.docid, id: args.data.paymentid,type: "Unofficial Purchase Invoice", mode: "invoice", voucher: voucherID, transcation: transcationID },
          success: function (fixtures) {
        ...
        {
          var voucherType = "Unofficial Payment Voucher";
          //args.data.Type;
          ...
          $.ajax({
            ...
            dataType: "json",
            cache: true,
            data: { language: "English", invoice: keys[2], ClientID: keys[0],currency: args.data.currency, total: args.data.total, invoiceSchemaID: keys[1], transcation: keys[4], invoiceNumber: args.data.invoiceNumber, docModel: voucherType, type: "Unofficial Payment Voucher", mode: "invoice", docID: keys[3], id: keys[0] },
            success: function (fixtures) {
                var html = fixtures["html"];
                // var paid = fixtures["paid"];
                $("#panel1").html(html);
          ...
          $.ajax({
            ...
            dataType: "json",
            cache: true,
            data: { language: "English", invoice: keys[2], ClientID: keys[0],currency: args.data.currency, total: args.data.total, invoiceSchemaID: keys[1], transcation: keys[4], invoiceNumber: args.data.invoiceNumber, type: "Unofficial Payment Voucher", mode: "invoice", docID: "", id: keys[0] },
            success: function (fixtures) {
                var html = fixtures["html"];
                // var paid = fixtures["paid"];
                $("#panel1").html(html);
