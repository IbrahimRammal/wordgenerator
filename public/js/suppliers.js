$( document ).ready(function() {
    ...
    let ajax = new ej.base.Ajax(hostUrl + "Suppliers/GetData", "post");
    ajax.send();
    ajax.onSuccess = function (result) {
        ...
        var data = new ej.data.DataManager({
            ...
            insertUrl: hostUrl + "Suppliers/BatchData", 
            updateUrl: hostUrl + "Suppliers/BatchData", 
            removeUrl: hostUrl + "Suppliers/BatchData"
        });
        ...
        var grid = new ej.grids.Grid({
            ...
            //toolbar: ['Search'],
            editSettings: { allowEditing: true, allowAdding: true, allowDeleting: true, mode: 'Dialog',showDeleteConfirmDialog: true }, //, allowDeleting: true
            columns: [
                {
