$(document).ready(function () {
    ...
    $.ajax({
        url: "/api/invoice/invoiceedit/GetData?action=purchasepronto&id=1",
        type: "POST",
        dataType: "json",
        cache: true,
        //data: { },
    ...
    var data = new ej.data.DataManager({
        ...
        insertUrl: hostUrl + "invoiceedit/GetData?action=purchasepronto&id=1",
        updateUrl: hostUrl + "invoiceedit/GetData?action=purchasepronto&id=1",
        removeUrl: hostUrl + "invoiceedit/GetData?action=purchasepronto&id=1",
    });
