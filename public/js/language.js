$( document ).ready(function() {
    ...
    let ajax = new ej.base.Ajax(hostUrl + "GetDataLanguage", "post");
    ajax.send();
    ajax.onSuccess = function (result) {
        ...
        var data = new ej.data.DataManager({
            ...
            insertUrl: hostUrl + "Language", 
            updateUrl: hostUrl + "Language", 
            removeUrl: hostUrl + "Language"
        });
        ...
        var grid = new ej.grids.Grid({
            ...
            columns: [
                {
                    field: 'language', headerText: 'Language',
                    validationRules: { required: true }, width: 100
                },
                {
                    field: '_id', headerText: 'Language ID', isPrimaryKey: true, textAlign: 'center', width: 120, visible: false 
                }, 
                {
