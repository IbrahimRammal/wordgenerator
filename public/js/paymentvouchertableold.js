$(document).ready(function () {
    ...
    let ajax = new ej.base.Ajax(
      hostUrl + "/PaymentSearch/GetData?action=all&id=2",
      "post"
    );
    ...
    ajax.onSuccess = function (result) {
      var data = new ej.data.DataManager({
        ...
        insertUrl: hostUrl + "/PaymentSearch/GetData?action=payment&id=2",
        updateUrl: hostUrl + "/PaymentSearch/GetData?action=payment&id=2",
        removeUrl: hostUrl + "/PaymentSearch/GetData?action=payment&id=2",
        //,
        // adaptor: new ej.data.RemoteSaveAdaptor(), //remote save adaptor
